...
async function pagarPedido(req,res){
    const {pago_metodo,pago_porcentaje_pedido,pago_cuotas,pago_fecha,tarjeta_id,pedido_id} = req.body;
    ...
    try {
        const newPagoPedido = Pago.create({
            ...
            fields:['pago_metodo','pago_porcentaje_pedido','pago_cuotas','pago_fecha','tarjeta_id','pedido_id']
        })
